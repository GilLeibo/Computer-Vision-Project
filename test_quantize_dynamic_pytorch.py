...
def main():
    ...
    if not distributed:
        ...
        results, elapsed_inference, MEM_avg, GPU_power_avg = single_gpu_test_modified_quantize(
            ...
            col_name="Pytorch_Post_Training_Dynamic_Quantization(int8)")
    ...
    cmd = 'printf "' + network_name + ' ' + power_mode_str + ' ' + "Pytorch_Post_Training_Dynamic_Quantization(int8)" + ' ' + elapsed_inference + ' ' + MEM_avg + ' ' + RAM_usage + ' ' + GPU_power_avg + ' ' + model_size + ' ' + mIoU_result + '\n"' + ' >> ' + 'quantization_recordings/quantization_data.txt'
