...
def main():
    ...
    cmd = 'printf "' + network_name + ' ' + power_mode_str + ' ' + "No_Quantization" + ' ' + elapsed_inference + ' ' + MEM_avg + ' ' + RAM_usage + ' ' + GPU_power_avg + ' ' + model_size + ' ' + mIoU_result + '\n"' + ' >> ' + 'quantization_recordings/quantization_data.txt'
